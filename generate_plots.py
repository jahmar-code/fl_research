...
ax.set_xlabel('Privacy Protection (1-MIA AUC)', fontsize=12)
ax.set_ylabel('Model Utility (Accuracy)', fontsize=12)
ax.set_zlabel('Communication Efficiency', fontsize=12)
ax.set_title('Three-Way Trade-off Analysis', fontsize=14)
ax.set_xlim(0, 0.6)
ax.set_ylim(0, 0.8)
ax.set_zlim(0, 1.0)
